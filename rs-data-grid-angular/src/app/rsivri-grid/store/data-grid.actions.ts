...
export const increasePageNum = createAction('[DataGrid/API] Increase Page Num');

export const decreasePageNum = createAction('[DataGrid/API] Decrease Page Num');

export const lastPageNum = createAction('[DataGrid/API] DecreLast Page Num');

  ...
  const column: IColumn[] = [
    {
      name: "Name",
      dataField: "name",
      customize: { height: "100px", width: "900px" },
      customizeHeader: { height: "30px", template: returnHeaderTemplate() },
    },
    {
      name: "Page",
      dataField: "web_pages",
      customize: { height: "100px", width: "1000px" },
    },
    {
      name: "Code",
      dataField: "alpha_two_code",
      customize: { height: "100px", template: returnTemplate() },
    },
    {
      name: "Country",
      dataField: "country",
